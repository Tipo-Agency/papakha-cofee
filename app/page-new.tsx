...
// Заглушки для категорий, которые еще не добавлены в data/products.ts
const saladProducts: Product[] = []
const sidesProducts: Product[] = []
const kidsMenuProducts: Product[] = []
const lemonadeProducts: Product[] = []
const freshJuicesProducts: Product[] = []
const coldCoffeeProducts: Product[] = []
const yogurtBowlProducts: Product[] = []
const smoothieProducts: Product[] = []
const kidsDrinksProducts: Product[] = []
